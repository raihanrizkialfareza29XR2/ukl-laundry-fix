...
// $query = 'SELECT outlet.*, user.* FROM outlet LEFT JOIN user ON user.outlet_id = outlet.id_outlet';
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                          ...
                                          <a href="outlet_detail.php?id=<?= $outlet['id_outlet']; ?>" data-toggle="tooltip" data-placement="bottom" title="Detail" class="btn btn-primary"><i class="fa fa-clipboard"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                    ...
                    <div class="modal fade" id="smallModal" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="outlet_hapus.php?id=<?= $outlet['id_outlet'] ?>" target="blank">
