...
$outlet_id = $_GET['id'];
$query = "SELECT user.*, outlet.* FROM user LEFT JOIN outlet ON outlet.id_outlet = user.outlet_id WHERE user.outlet_id = " . $outlet_id;
// die($query);
// die($query);
                    ...
                    <table class="table table-bordered thead-dark" id="table">
                        ...
                        <tbody>
                            <?php foreach($data as $outlet): ?>
                                <tr>
                                    <td></td>
                                    <td><?= htmlspecialchars($outlet['nama_user']); ?></td>
                                    <!-- <td>
                                    ...
                                    <td><?= htmlspecialchars($outlet['role']); ?></td>
                                    <!-- <td><?= htmlspecialchars($outlet['alamat_outlet']); ?></td> -->
                                    <td align="center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                          <a href="pengguna_edit.php?id=<?= $outlet['id_user']; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                          <a href="pengguna_hapus.php?id=<?= $outlet['id_user']; ?>" onclick="return confirm('Yakin hapus data ? ');" data-toggle="tooltip" data-placement="bottom" title="Hapus" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
